...
GENERIC2.WTH: nc_wth_gen
	./nc_wth_gen 1980 2010 $(in_dir) $(out_dir) $@ $(n_procs) 2 # &> log/GENERIC2.LOG

GENERIC3.WTH: nc_wth_gen
	./nc_wth_gen 2010 2040 $(in_dir) $(out_dir) $@ $(n_procs) 3 # &> log/GENERIC3.LOG

GENERIC4.WTH: nc_wth_gen
	./nc_wth_gen 2040 2070 $(in_dir) $(out_dir) $@ $(n_procs) 4 # &> log/GENERIC4.LOG

GENERIC5.WTH: nc_wth_gen
	./nc_wth_gen 2070 2100 $(in_dir) $(out_dir) $@ $(n_procs) 5 # &> log/GENERIC5.LOG
